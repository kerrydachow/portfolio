...
const AboutSection = () => {
  return (
    <>
      <div className="lg:flex lg:flex-row-reverse md:justify-between md:items-center md:h-full gap-16">
        <motion.div
          variants={fadeIn("left", "spring", 0.75, 1.5)}
          className="basis-1/2 relative z-0 before:absolute before:-top-10 before:-right-10 before:rounded-t-full
        ...
        >
          <img
            alt="profile"
            className="rounded-t-full my-5 lg:my-0 custom-position mx-auto hover:filter hover:saturate-150 transition duration-500 z-10 w-full md:max-w-[600px]"
            src={me1}
          />
        </motion.div>
        <motion.div className="lg:basis-1/2" variants={textVariant()}>
